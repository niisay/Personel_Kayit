...
namespace Personel_Kayit
{
    public partial class FrmGiris: Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * From YoneticiTablosu where KullaniciAd=@p1 and Sifre = @p2",baglanti);
            ...
            {
                MessageBox.Show("Hatali Kullanici Adı ya da Şifre");
            }
                baglanti.Close();
        }
    }
