...
namespace Personel_Kayit
{
    public partial class FrmAnaForm : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into PersonelTablosu (PerAd,PerSoyad,PerSehir,PerMaas,PerMeslek,PerDurum) values (@p1,@p2,@p3,@p4,@p5,@p6)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komutguncelle = new SqlCommand("Update PersonelTablosu Set PerAd = @a1, PerSoyad = @a2, PerSehir=@a3, PerMaas = @a4, PerDurum = @a5, PerMeslek = @a6 where Perid=@a7",baglanti);
